...
<body class="bg-gray-50">
    ...
    <div class="lg:ml-64 pb-24 lg:pb-0">
        ...
        <nav class="bg-white border-b border-gray-100 sticky top-0 z-20">
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="invoices"
                            class="px-3 py-1.5 border border-gray-200 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition flex items-center gap-2">
        ...
        <main class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-500 mt-1 text-sm">Select a client and date range, pick the schedules to bill, and
                    generate the invoice.</p>
            </div>
                    ...
                    <div class="w-full sm:flex-1 sm:min-w-[200px]">
                        ...
                        <select id="clientSelect" class="form-select">
                            ...
                            foreach ($clients_list as $c):
                                ...
                                ?>
                                <option value="<?= (int) $c['client_id'] ?>"
                                    data-rate="<?= htmlspecialchars($c['bill_rate'] ?? '0') ?>">
                                    <?= $name . $rate ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
            ...
            <div class="flex gap-6 items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div id="stateInitial" class="state-box">
                        ...
                        <p class="text-gray-400 text-sm mt-1">Select a client and date range above, then click Search.
                        </p>
                    </div>
                    ...
                    <div id="stateEmpty" class="state-box hidden">
                        ...
                        <p class="text-gray-400 text-sm mt-1">This client has no schedules in the selected date range.
                        </p>
                    </div>
                    ...
                    <div id="stateResults" class="hidden">
                        <!-- Toolbar -->
                        <div
                            class="bg-white rounded-xl shadow-sm px-5 py-3 mb-4 flex flex-wrap gap-3 items-center justify-between">
                            <div class="flex items-center gap-3">
                                <label class="flex items-center gap-2 cursor-pointer select-none">
                                    <input type="checkbox" id="globalCheckbox" onchange="handleGlobalCheckbox()"
                                        class="w-4 h-4">
                            ...
                            <div class="flex flex-wrap gap-2 items-center">
                                ...
                                <button onclick="setFilter('pending')" id="pill-pending" class="filter-pill">Pending
                                    Only</button>
                                <button onclick="setFilter('processed')" id="pill-processed"
                                    class="filter-pill">Invoiced</button>
                                <div class="relative">
                                    <i
                    ...
                    <div class="summary-panel bg-white rounded-xl shadow-sm p-5">
                        ...
                        <div id="summaryDetails" class="hidden">
                            ...
                            <div class="border-t border-gray-100 pt-4 mt-2">
                                ...
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Notes <span
    ...
    <div class="mobile-summary-bar" id="mobileSummaryBar">
        <div class="flex-1">
            ...
            <p class="text-sm font-bold text-[#003366]"><span id="mobSchedules">0</span> schedules · <span
                    id="mobTotal">$0.00</span></p>
        </div>
    ...
    <div id="mobileModal" class="hidden fixed inset-0 z-50 flex items-end">
        ...
        <div class="relative bg-white rounded-t-2xl w-full p-5 shadow-xl">
            ...
            <div class="space-y-2.5 mb-4">
                <div class="flex justify-between text-sm"><span class="text-gray-500">Schedules</span><strong
                        id="mobModalSchedules">0</strong></div>
                <div class="flex justify-between text-sm"><span class="text-gray-500">Staff</span><strong
                        id="mobModalStaff">0</strong></div>
                <div class="flex justify-between text-sm"><span class="text-gray-500">Hours</span><strong
                        id="mobModalHours">0.00</strong></div>
                <div class="flex justify-between text-sm"><span class="text-gray-500">Subtotal</span><strong
                        id="mobModalSubtotal">$0.00</strong></div>
                <div class="flex justify-between text-sm"><span class="text-gray-500">GST (13%)</span><strong
                        id="mobModalGst">$0.00</strong></div>
                <div class="flex justify-between text-sm font-semibold border-t pt-2.5"><span>Total</span><span
                        class="text-[#99CC33] text-base" id="mobModalTotal">$0.00</span></div>
            </div>
    ...
    <div id="confirmModal" class="hidden fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
            <div class="text-center mb-5">
                <div
                    class="w-16 h-16 bg-[#003366] bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <div class="flex gap-3">
                <button onclick="closeConfirmModal()"
                    class="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 transition">
                    Cancel
                </button>
